package com.example.t.app.activity_erweima.android;
...
import com.example.t.app.activity_erweima.camera.CameraManager;
import com.example.t.app.activity_erweima.common.Constant;
import com.example.t.app.activity_erweima.decode.DecodeImgCallback;
import com.example.t.app.activity_erweima.decode.DecodeImgThread;
import com.example.t.app.activity_erweima.decode.ImageUtil;
import com.example.t.app.activity_erweima.view.ViewfinderView;
                ...
                if (grantResults.length > 0) {
                    for (int i : grantResults) {
                        if (i != PackageManager.PERMISSION_GRANTED) {
                            Toast.makeText(this, "必须授权才可使用相机", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                } else {
